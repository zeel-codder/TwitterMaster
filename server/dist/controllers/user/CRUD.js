...
exports.GetTokeInfo = exports.SingIn = exports.GetUser = exports.UpdateUser = exports.DeleteUser = exports.AddUser = exports.GetUsers = void 0;
...
var GetTokeInfo = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var token, user, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                return [2 /*return*/, res.status(200).send(Helper_1.ResultLoader("User Info", { user: user }))];
            case 2:
                e_1 = _a.sent();
                res.status(404).send(Helper_1.ErrorLoader("Token Invalid", e_1.message));
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
}); };
exports.GetTokeInfo = GetTokeInfo;
var GetUsers = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var number, List, UserList, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
            ...
            case 1:
                ...
                if (List.length < number) {
                    return [2 /*return*/, res
                            .status(200)
                            .send(Helper_1.ResultLoader("All Tweet", { List: UserList, isEnd: true }))];
                }
                res
                    .status(200)
                    .send(Helper_1.ResultLoader("All Users", { List: UserList, isEnd: false }));
                return [3 /*break*/, 3];
            case 2:
                e_2 = _a.sent();
                res.status(404).send(Helper_1.ErrorLoader("UserList not found", e_2.message));
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var GetUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                e_3 = _a.sent();
                res.status(404).send(Helper_1.ErrorLoader("User not found", e_3.message));
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var AddUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newUser, findByName, findByEmail, hash, newDoc, user, token, result, e_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
            ...
            case 1:
                findByName = _a.sent();
                return [4 /*yield*/, Schema_1.UserModel.findOne({
            ...
            case 2:
                ...
                if (findByName || findByEmail) {
                    ...
                    return [2 /*return*/, res
                            .status(500)
                            .send(Helper_1.ErrorLoader("User Name and Email Exits", "UserFound"))];
                }
...
var SingIn = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name_2, password, findByName, isPasswordSame, token, result, e_5;
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                if (!findByName) {
                    ...
                    return [2 /*return*/, res
                            .status(500)
                            .send(Helper_1.ErrorLoader("User Not Exits", "UserNotFound"))];
                }
            ...
            case 2:
                ...
                if (!isPasswordSame) {
                    return [2 /*return*/, res
                            .status(401)
                            .send(Helper_1.ErrorLoader("PassWord Wrong", "UserNotFound"))];
                }
                token = jsonwebtoken_1.default.sign(JSON.stringify(findByName), process.env.JWT_SECRET);
                result = {
                    message: "User fount",
            ...
            case 3:
                e_5 = _b.sent();
                //        console.log(e);
                res.status(404).send(Helper_1.ErrorLoader(e_5.message, "Error"));
                return [3 /*break*/, 4];
...
var UpdateUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, before, after, name_4, _b, newUser, UserDelete, e_7;
        ...
        switch (_c.label) {
            ...
            case 2:
                ...
                if (after.image === "f") {
                    ...
                    Media_1.cloudinary.uploader.destroy("Users/" + name_4 + ".jpg", function (result) {
                        console.log(result);
                    });
            ...
            case 4:
                e_7 = _c.sent();
                console.log(e_7);
                res.status(404).send(Helper_1.ErrorLoader("UserList not found", e_7.message));
                return [3 /*break*/, 5];
